...
var die_1 = require('../../entities/die');
var GameBoardComponent = (function () {
    ...
    /**
     * Gets image path randomly from "dieImages" array and apply it to "img" property of Die object
     *
     * tempDieArray exists to facilitate change detection when using custom pipe
     * change detection happens when array reference is changed -> link: https://angular.io/docs/ts/latest/guide/pipes.html
     */
    GameBoardComponent.prototype.rollDice = function () {
        if (this.rollCount < 3) {
            var tempDieArray = new Array(5);
